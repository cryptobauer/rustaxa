...
pub mod application_host_ffi {
    ...
    extern "Rust" {
        ...
        /// Recovers concrete state and pending FinalChain publication as one
        /// native application-root operation over the exact StateAPI leaf.
