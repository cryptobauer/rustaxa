...
//!
//! The bridge exposes a byte-oriented generation contract to the C++ signing
//! executor leaf. Rust composes weighted generation with borrowed FinalChain
//! state; C++ retains secret custody, signing dispatch, and temporary live
//! `PbftVote` materialization from canonical Rust-generated bytes.
...
#[cfg(test)]
use rustaxa_consensus::pbft_vote_generation::generate_pbft_vote;
...
/// Generates one signed PBFT vote payload for native bridge unit coverage.
#[cfg(test)]
