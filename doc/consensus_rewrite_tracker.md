...
Recommended next selection: choose a bounded sibling-service ownership slice from `CRW-04` or `CRW-05`. `CRW-03` is
complete after closing leader snapshot/revalidation, admission-plus-progress persistence, and atomic vote/proposed
period cleanup.
