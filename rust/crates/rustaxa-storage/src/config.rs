...
impl Column {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Column::FinalizedRewardVoteCursor => "finalized_reward_vote_cursor",
    ...
    pub fn from_name(name: &str) -> Result<Column> {
        match name {
            ...
            "finalized_reward_vote_cursor" => Ok(Column::FinalizedRewardVoteCursor),
