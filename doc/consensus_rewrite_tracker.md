...
is classified as executor/compatibility work: FinalChain/DPoS fact sourcing, EVM gas
execution, event/network/public object materialization, local cache cleanup execution from Rust payloads, and live
transaction-manager sidecar cleanup.
