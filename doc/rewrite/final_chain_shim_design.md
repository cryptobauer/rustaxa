# FinalChain Shim Design (Batch 1 Scaffold)
...
- no behavior changes in Batch 1
...
All public methods are explicitly redeclared and forwarded to `FinalChainOld`:
...
- no Rust-backed FinalChain method behavior
