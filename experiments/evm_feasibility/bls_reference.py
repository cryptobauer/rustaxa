...
def validate_artifact(label, data):
    ...
    needed = {
        "g1-add-non-subgroup",
        "g1-mul-non-subgroup-order-minus-one",
        "g1-mul-non-subgroup-order",
        "g1-mul-non-subgroup-order-plus-one",
        "g1-mul-non-subgroup-twice-order-minus-one",
        "g1-mul-non-subgroup-twice-order",
        "g1-mul-non-subgroup-twice-order-plus-one",
        "g1-multiexp-non-subgroup-one",
        "g1-multiexp-mixed-subgroup-non-subgroup-high",
        "g1-multiexp-k128-discount",
        "g1-multiexp-k129-cap",
        "g2-add-non-subgroup",
        "g2-mul-non-subgroup-order-minus-one",
        "g2-mul-non-subgroup-order",
        "g2-mul-non-subgroup-order-plus-one",
        "g2-mul-non-subgroup-twice-order-minus-one",
        "g2-mul-non-subgroup-twice-order",
        "g2-mul-non-subgroup-twice-order-plus-one",
